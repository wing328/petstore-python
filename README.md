...
- Build date: 2016-03-30T18:04:28.090+08:00
...
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wing328/petstore-python.git`)
...
Download the package (e.g. using `git clone`) to the project folder (e.g. ./path/to/pet_store) and import the package:
