...
- API verion: 1.0.0
- Package version: 
- Build date: 2016-03-30T17:46:21.203+08:00
...
Download the latest release to the project folder (e.g. ./path/to/Petstore) and import the package:

```python
import path.to.Petstore
```
